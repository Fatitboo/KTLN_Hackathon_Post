    ...
    <Link to={`/Seeker/project/${id}`}>
      <div className="relative cursor-pointer max-w-xs bg-white border border-gray-300 rounded-sm hover:shadow-md">
        ...
        <div className="">
          ...
          <div className=" mt-4 flex justify-between px-2 items-center bg-gray-100 align-bottom">
            ...
            <div className=" flex justify-between p-2 bg-gray-100 align-bottom">
              <div className="flex -space-x-2 ">
                <img
                  className="w-6 h-6 rounded-full border-2 border-white"
                  src={imgUser}

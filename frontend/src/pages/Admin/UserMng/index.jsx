...
function UserMng() {
  ...
  const { corList, isSuccess, appErr, loading, isSuccessUpd, userProfile } =
    storeData;
  ...
  useEffect(() => {
    if (isSuccess) {
      ...
      setOrganizerList(OrganizerList.map((item) => item));
  ...
  useEffect(() => {
    if (isSuccessUpd) {
      ...
      Swal.fire({
        title: "Updated!",
        text: "This active status of user has been updated.",
        icon: "success",
          ...
          <div className="relative rounded-lg mb-8 bg-white shadow max-w-full px-3 pt-1 shrink-0 w-full">
            <div className="relative w-full">
              ...
              <div className="relative flex justify-between items-center flex-wrap bg-transparent px-8 py-5">
                    ...
                    <div>
                      <div className="relative mb-0">
                        ...
                        <input
                          ...
                          id="search-field"
                          placeholder="Search"
                          className="relative  focus:bg-white  mt-2 block w-72 border pt-1 pb-1 pl-10 h-9 pr-5 text-sm bg-[#f0f5f7] rounded-md"
                        />
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex ">
                  <div className="mr-1 font-medium">Registed Organizer: </div>{" "}
                  <span>
                    {" "}
                    {pages.length} / {OrganizerList.length} Organizers
                  </span>
                </div>
              </div>
                ...
                <div className="overflow-y-hidden overflow-x-auto text-[15px]">
                  <table className="relative w-full overflow-y-hidden overflow-x-hidden rounded-md mb-8 bg-white border-0">
                    <thead className="bg-[#f5f7fc] color-white border-transparent border-0 w-full">
                      <tr className="w-full">
                        <th className="relative text-[#3a60bf] font-medium py-6 text-base text-left w-3/12 pl-5 pr-0">
                          Organizer Name
                        </th>
                        <th className="relative text-[#3a60bf] font-medium py-6 text-base px-0 text-left w-1/8">
                          Email
                        </th>
                        <th className="relative text-[#3a60bf] font-medium py-6 text-base text-left w-1/10">
                          PhoneNum
                        </th>
                        <th className="relative text-[#3a60bf] font-medium py-6 text-base text-left w-1/8">
                          Founding Date
                        </th>
                        <th className="relative text-[#3a60bf] font-medium py-6 text-base text-left w-1/8">
                          Register Date

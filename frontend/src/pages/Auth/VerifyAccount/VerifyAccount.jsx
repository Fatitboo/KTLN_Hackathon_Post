      ...
      {isVerified ? (
        <div className="w-full h-[70vh] flex pt-24 items-center flex-col relative">
          ...
          <div className="w-[418px] flex items-center flex-col">
            ...
            {<div className="text-sm text-blue-700">Account Verified!</div>}
            <div className="text-4xl font-bold mt-3 mb-2">Login back!</div>
            <div className="text-sm mb-2 text-[#6c757d] text-center px-4">
              Your account is now verified. Please Logout and login back to see
              the changes.
            </div>
        ...
        <div className="text-sm text-red-700">{appErr}</div>
      ) : (
        <div className="h-[800px] flex items-center justify-center">
          <img src={pleaseWaiting} alt="" className="w-40" />
        </div>
      )}
    </>
  );

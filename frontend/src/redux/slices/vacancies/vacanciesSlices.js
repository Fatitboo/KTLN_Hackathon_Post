  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.get(
        `${baseUrl}/${apiPrefix}/posting/${payload}`,
        config
      );
      return data;
    } catch (error) {
...
export const getVacancyComponent = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.get(
        `${baseUrl}/${apiPrefix}/posting/${payload.id}/${payload.flag}`,
        config
      );
      return data;
    } catch (error) {
...
export const getVacancyInfoDetail = createAsyncThunk(
  ...
  async (id, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.get(
        `${baseUrl}/${apiPrefix}/get-vacancy-by-id/${id}`,
        config
      );
      return data;
    } catch (error) {
  ...
  async (vacancy, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.put(
        `${baseUrl}/${apiPrefix}/posting/${vacancy.id}`,
        { ...vacancy.value },
        config
      );
      return data;
...
export const updateVacancyStatus = createAsyncThunk(
  ...
  async (dt, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.put(
        `${baseUrl}/${apiPrefix}/update-status-vacancy/${dt.id}`,
        formData,
        config
      );
      return data;
...
export const getVacancyCor = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.get(
        `${baseUrl}/api/v1/users/get-vacancy-cor/${userAuth?.user?.userId}`,
        config
      );
      return data;
    } catch (error) {
...
export const getCompleteVacancyCor = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.get(
        `${baseUrl}/api/v1/users/get-complete-vacancy-cor/${userAuth?.user?.userId}`,
        config
      );
      return data;
    } catch (error) {
...
export const getInCompleteVacancyCor = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.get(
        `${baseUrl}/api/v1/users/get-incomplete-vacancy-cor/${userAuth?.user?.userId}`,
        config
      );
      return data;
    } catch (error) {
...
export const getFullUnCompletedVacancy = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.get(
        `${baseUrl}/${apiPrefix}/uncompleted-vacancy/${payload}`,
        config
      );
      return data;
    } catch (error) {
...
export const postFullVacancy = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      console.log(userAuth?.user?.userId);
      const { data } = await axios.post(
        `${baseUrl}/${apiPrefix}/post/${payload}`,
        payload,
        config
      );
      return data;
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.delete(
        `${baseUrl}/${apiPrefix}/delete-uncompleted-vacancy/${payload}`,
        config
      );
      return data;
    } catch (error) {
...
export const getAllApplicantVacancy = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.get(
        `${baseUrl}/${apiPrefix}/get-all-applicants-vacancy/${payload}`,
        config
      );
      return data;
    } catch (error) {
...
export const applyVacancy = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.post(
        `${baseUrl}/${apiPrefix}/apply-vacancies/${user.userId}/${payload.vacancyId}/${payload}`,
        user.userId,
        config
      );
      return data;
...
export const getAllParticipantsVacancy = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.get(
        `${baseUrl}/${apiPrefix}/get-all-participant-vacancy/${payload}`,
        config
      );
      return data;
    } catch (error) {
...
export const acceptApplicantVacancy = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.post(
        `${baseUrl}/${apiPrefix}/accept-applicant-vacancy/${payload.vacancyId}/${payload.id}`,
        user.userId,
        config
      );
      return data;
...
export const removeApplicantVacancy = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.put(
        `${baseUrl}/${apiPrefix}/remove-applicant-vacancy/${payload.vacancyId}/${payload.id}`,
        user.userId,
        config
      );
      return data;
...
export const blockMemberVacancy = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.put(
        `${baseUrl}/${apiPrefix}/block-member-vacancy/${payload.vacancyId}/${payload.id}`,
        user.userId,
        config
      );
      return data;
...
export const recoverMemberVacancy = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.put(
        `${baseUrl}/${apiPrefix}/recover-member-vacancy/${payload.vacancyId}/${payload.id}`,
        user.userId,
        config
      );
      return data;
...
export const deleteBlockMemberVacancy = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.put(
        `${baseUrl}/${apiPrefix}/delete-block-member-vacancy/${payload.vacancyId}/${payload.id}`,
        user.userId,
        config
      );
      return data;
  ...
  async (obj, { rejectWithValue, getState, dispatch }) => {
    ...
    try {
      ...
      if (obj.setFunc) {
        obj.setFunc((prev) => {
          var arr = [...prev];
          const currentVacancy = arr.findIndex(
            (item) => item.vacancyId === data.vacancyId
          );
          if (currentVacancy !== -1) {
            if (data.isPush) {
              if (arr[currentVacancy].favouriteUsers === null) {
                arr[currentVacancy] = {
                  ...arr[currentVacancy],
                  favouriteUsers: [data.userId],
                };
              } else {
                arr[currentVacancy] = {
                  ...arr[currentVacancy],
                  favouriteUsers: [
                    ...arr[currentVacancy].favouriteUsers,
                    data.userId,
                  ],
                };
              }
              ...
              arr[currentVacancy] = {
                ...arr[currentVacancy],
                favouriteUsers: [
                  ...arr[currentVacancy].favouriteUsers.filter(
...
export const getAllFavouriteVacanciesAction = createAsyncThunk(
  ...
  async (vacancyId, { rejectWithValue, getState, dispatch }) => {
    ...
    try {
      const { data } = await axios.get(
        `${baseUrl}/${apiPrefix}/get-favourite-vacancies/${userAuth?.user?.userId}`,
        config
      );
      return data;
    } catch (error) {
...
export const getAllAppliedVacanciesAction = createAsyncThunk(
  ...
  async (userId, { rejectWithValue, getState, dispatch }) => {
    ...
    try {
      const { data } = await axios.get(
        `${baseUrl}/${apiPrefix}/get-applied-vacancies/${id}`,
        config
      );
      return data;
    } catch (error) {
...
export const getAllReportsAdminAction = createAsyncThunk(
  ...
  async (type, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.get(
        `${baseUrl}/api/v1/hackathons/get-reports/${type}`,
        config
      );
      console.log(data);
      return data;
...
export const searchVacancyAction = createAsyncThunk(
  ...
  async (d, { rejectWithValue, getState, dispatch }) => {
    try {
      ...
      const { data } = await axios.get(
        `${baseUrl}/api/v1/vacancies/search-vacancies?keyWord=${d?.keywords}&location=${d?.city}&jobType=${d?.jobType}`,
        config
      );
      console.log(data);
      return data;
...
const vacanciesSlices = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(getAllVacancies.pending, (state, action) => {
      ...
      builder.addCase(updateVacancyStatus.fulfilled, (state, action) => {
        ...
        if (state.vacancies.length === 0) {
          state.vacProList.pop(
            (item) => item.vacProId === action?.payload?.updateVacancyId
          );
        } else {
          let currentVacancy = state.vacancies.findIndex(
            (v) => v.vacancyId === action?.payload?.updateVacancyId
          );
          if (currentVacancy !== -1)
            state.vacancies[currentVacancy].approvalStatus =
      ...
      builder.addCase(
        getCurrentVacanciesComponent.fulfilled,
        (state, action) => {
          state.loading = false;
          state.appErr = null;
      ...
      builder.addCase(
        getCurrentVacanciesComponent.rejected,
        (state, action) => {
          state.loading = false;
          state.appErr = action?.payload?.message;
          state.isSuccess3 = false;
      ...
      builder.addCase(
        deleteuncompletedVacancyAction.pending,
        (state, action) => {
          state.loading = true;
      ...
      builder.addCase(
        deleteuncompletedVacancyAction.fulfilled,
        (state, action) => {
          state.loading = false;
          state.appErr = null;
          state.isSuccessDL = true;
          state.incomplete = state.incomplete.filter(
            (item) => item.vacancyId !== action.payload.id
          );
        }
      ),
      builder.addCase(
        deleteuncompletedVacancyAction.rejected,
        (state, action) => {
          state.loading = false;
          state.appErr = action?.payload?.message;
          state.isSuccessDL = false;
      ...
      builder.addCase(blockMemberVacancy.fulfilled, (state, action) => {
        ...
        state.appErr = null;
        const a = state?.participants?.members?.find(
          (item) => item.userId === action?.payload?.id
        );
        if (a) {
          state?.participants?.oldMembers.push(a);
          state.participants.members = state?.participants?.members?.filter(
            (item) => item.userId !== action.payload.id
          );
        }
      }),
      ...
      builder.addCase(recoverMemberVacancy.fulfilled, (state, action) => {
        ...
        state.appErr = null;
        const a = state?.participants?.oldMembers?.find(
          (item) => item.userId === action?.payload?.id
        );
        if (a) {
          state?.participants?.members.push(a);
          state.participants.oldMembers =
            state?.participants?.oldMembers?.filter(
              (item) => item.userId !== action.payload.id
            );
        }
      }),
      ...
      builder.addCase(deleteBlockMemberVacancy.fulfilled, (state, action) => {
        ...
        state.appErr = null;
        state.participants.oldMembers = state.participants.oldMembers.filter(
          (item) => item.userId !== action.payload.id
        );
      }),
      ...
      builder.addCase(
        updateFavouriteVacancyAction.fulfilled,
        (state, action) => {
          state.loadingFvr = false;
          state.loading = false;
          state.appErr = undefined;
          if (
            Object.keys(state.vacancyInfo).length === 0 &&
            state.vacancyInfo.constructor === Object
          ) {
            var currentVacancy = state.vacancies.findIndex(
              (vacancy) => vacancy.vacancyId === action?.payload?.vacancyId
            );
            if (currentVacancy !== -1) {
              if (action?.payload?.isPush) {
                if (state.vacancies[currentVacancy].favouriteUsers)
                  state.vacancies[currentVacancy].favouriteUsers.push(
                    action?.payload?.userId
                  );
                else
                  state.vacancies[currentVacancy].favouriteUsers = [
                    action?.payload?.userId,
                  ];
              } else {
                state.vacancies[currentVacancy].favouriteUsers.pop(
                  action?.payload?.userId
                );
              }
            } else {
              if (state.favouriteVacancies) {
                ...
                state.favouriteVacancies = state.favouriteVacancies.filter(
                  (item) => item?.vacancyId !== action?.payload?.vacancyId
                );
              }
            }
          } else {
      ...
      builder.addCase(
        updateFavouriteVacancyAction.rejected,
        (state, action) => {
          state.loadingFvr = false;
          state.appErr = action?.payload?.message;
          state.isSuccessFvr = false;
    ...
    builder.addCase(getAllFavouriteVacanciesAction.pending, (state, action) => {
      ...
      builder.addCase(
        getAllFavouriteVacanciesAction.fulfilled,
        (state, action) => {
          state.loading = false;
          state.appErr = undefined;
          state.isSuccess2 = true;
      ...
      builder.addCase(
        getAllFavouriteVacanciesAction.rejected,
        (state, action) => {
          state.loading = false;
          state.appErr = action?.payload?.message;
          state.isSuccess2 = false;
      ...
      builder.addCase(
        getAllAppliedVacanciesAction.fulfilled,
        (state, action) => {
          state.loading = false;
          state.appErr = undefined;
          state.isSuccess2 = true;
      ...
      builder.addCase(
        getAllAppliedVacanciesAction.rejected,
        (state, action) => {
          state.loading = false;
          state.appErr = action?.payload?.message;
          state.isSuccess2 = false;
      ...
      builder.addCase(getAllReportsAdminAction.fulfilled, (state, action) => {
        state.loading = false;
        state.vacProList = action?.payload;
        state.appErr = null;
        state.isSuccess2 = true;
      }),
